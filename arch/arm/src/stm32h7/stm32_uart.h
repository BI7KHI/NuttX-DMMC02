...
/* Is there a USART enabled? */
    ...
    defined(CONFIG_STM32H7_UART9)  || defined(CONFIG_STM32H7_USART10)
#  define HAVE_UART 1
#endif
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_UART9_SERIAL_CONSOLE) && defined(CONFIG_STM32H7_UART9)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_USART10_SERIAL_CONSOLE) && defined(CONFIG_STM32H7_USART10)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
...
#else
#  define USART_CR1_USED_INTS    (USART_CR1_RXNEIE | USART_CR1_TXEIE | USART_CR1_PEIE | USART_CR1_IDLEIE)
#endif
